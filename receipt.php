...
$query = "SELECT si.*, p.brand, p.model, p.code, p.barcode, p.imei, p.serial_number
          FROM sale_items si 
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="item-details">
                                Code: <?php echo htmlspecialchars($item['code']); ?><br>
                                <?php if ($item['barcode']): ?>Barcode: <?php echo htmlspecialchars($item['barcode']); ?><br><?php endif; ?>
                                <?php if ($item['imei']): ?>IMEI: <?php echo htmlspecialchars($item['imei']); ?><br><?php endif; ?>
                                <?php if ($item['serial_number']): ?>SN: <?php echo htmlspecialchars($item['serial_number']); ?><?php endif; ?>
                            </div>
                        </td>
