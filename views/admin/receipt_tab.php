            ...
            <div>
                ...
                <div class="payment-method-section" style="margin: 15px 0;">
                    ...
                    <div style="margin-top: 10px;">
                        <button type="button" class="btn btn-sm btn-primary" onclick="console.log('addPaymentRow function:', typeof addPaymentRow); addPaymentRow()">+ Add Payment Method</button>
